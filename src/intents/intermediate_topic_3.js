...
let intent = (inputData, object, cb) => {
  ...
  let storageKey = inputData.userId + '_intermediate_topic_3';
  let userLevel = localStorage.getItem(storageKey);
  let contentData = {title: "Next", payload: "intermediate_topic_3"};
  const images = require('../contents/images.json')["intermediate"]["topic_3"];
