...
let intent = (inputData, object, cb) => {
  ...
  let storageKey = inputData.userId + '_beginner_topic_3';
  let userLevel = localStorage.getItem(storageKey);
  let contentData = {title: "Next", payload: "beginner_topic_3"};
  const images = require('../contents/images.json')["beginner"]["topic_3"];
