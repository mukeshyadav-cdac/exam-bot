...
let intent = (inputData, object, cb) => {
  ...
  let storageKey = inputData.userId + '_intermediate_topic_2';
  let userLevel = localStorage.getItem(storageKey);
  let contentData = {title: "Next", payload: "intermediate_topic_2"};
  const images = require('../contents/images.json')["intermediate"]["topic_2"];
